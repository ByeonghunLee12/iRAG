...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        down_block_additional_residuals_ref: Optional[torch.Tensor] = None,
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            down_block_additional_residual_ref = down_block_additional_residuals_ref[-len(upsample_block.resnets) :]
            down_block_additional_residuals_ref = down_block_additional_residuals_ref[: -len(upsample_block.resnets)]
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                sample = upsample_block(
                    ...
                    pixelwise_hidden_states_ref=down_block_additional_residual_ref,
                    cross_attention_kwargs=cross_attention_kwargs,
