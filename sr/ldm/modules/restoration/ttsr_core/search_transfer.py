# Ported from researchmm/TTSR/model/SearchTransfer.py (MIT License).
import torch
...
class SearchTransfer(nn.Module):
    ...
    def forward(self, lrsr_lv3, refsr_lv3, ref_lv1, ref_lv2, ref_lv3):
        ...
        T_lv2 = F.fold(T_lv2_unfold, output_size=(lrsr_lv3.size(2) * 2, lrsr_lv3.size(3) * 2),
                       kernel_size=(6, 6), padding=2, stride=2) / (3. * 3.)
        T_lv1 = F.fold(T_lv1_unfold, output_size=(lrsr_lv3.size(2) * 4, lrsr_lv3.size(3) * 4),
